...
import com.example.administrator.partymemberconstruction.FirstActivity;
    ...
    public void onReceive(Context context, Intent intent) {
        try {
            ...
            if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
                ...
                Log.e("ts", "title" + title + "content" + content + "extras" + extras);
